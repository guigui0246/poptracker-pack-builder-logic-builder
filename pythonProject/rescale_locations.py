...
def key_lookup(json_dict: dict[str, list[dict[str, Any]]]) -> dict[str, list[dict[str, int]]]:
    ...
    if "children" in json_dict.keys():
        for index, _ in enumerate(json_dict["children"]):
...
if __name__ == '__main__':
    ...
    old_img = filedialog.askopenfilename()
    print("Select new image:")
    new_img = filedialog.askopenfilename()
